...
from config import ATLASSIAN_API_BASE_URL, ATLASSIAN_BASE_URL, ATLASSIAN_PASSWORD, ATLASSIAN_USERNAME
import numpy as np
...
STOPWORDS = {
    ...
    "i", "am", "facing", "you", "your", "we", "our", "it", "this", "those", "these", "as", "be", "if", "or"
}
...
def get_page_views(page_id):
    analytics_url = f"{ATLASSIAN_BASE_URL}/rest/api/analytics/content/{page_id}/views"
...
def search_confluence(cql_query):
    ...
    if response.status_code == 200:
        ...
        for result in results:
            ...
            content_url = f"{ATLASSIAN_BASE_URL}/wiki/pages/viewpage.action?pageId={page_id}"
...
def fetch_confluence_pages(query):
    ...
    return search_confluence(combined_query, query=corrected_query)



print(fetch_confluence_pages("how to setup SSH key in gitlab"))